            ...
            public void onClick(View v) {
                if(alumno == null){
                    ...
                    if(imgURI != null){
                        ...
                        alumno.setImgURI("android.resource://com.example.recycleview/" + R.drawable.personaadd);
                    }
        ...
        btnBorrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(posicion >= 0){
                    ...
                    Toast.makeText(AlumnoAlta.this, "No puede utilizar esta opcion", Toast.LENGTH_SHORT).show();
                }
            }
        });
